...
const AdminPanel = () => {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch('https://restaurant-application-backend.onrender.com/admin-panel');
    ...
    const makeAdmin = async (username) => {
        ...
        if (makeAdminConfirmed) {
            ...
            try {
                const response = await fetch('https://restaurant-application-backend.onrender.com/admin-panel/make-admin', {
                    method: 'POST',
                    headers: {
    ...
    const makeUser = async (username) => {
        ...
        if (makeUserConfirmed) {
            ...
            try {
                const response = await fetch('https://restaurant-application-backend.onrender.com/admin-panel/make-user', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                    },
